...
export const PROVIDERS: readonly ProviderCapabilityCard[] = [
  {
    ...
    scopes: {
      ...
      cards: ["cards:write"],
      sensitiveCardData: ["cards:sensitive:read"],
    },
    cardOperations: {
    ...
    limitations: ["Card API support is recent; documented lifecycle actions stay non-executable until conformance verifies sandbox/live behavior."],
  },
  {
    id: "bunq",
    displayName: "bunq",
    ...
    scopes: {
      ...
      cards: ["card:write"],
      sensitiveCardData: ["card-cvc2:read"],
    },
    cardOperations: {
      createVirtual: documented,
      updateSettings: documented,
    ...
    limitations: ["Official SDKs are not the preferred current integration path; build direct API contracts and signing tests."],
  },
  {
    id: "revolut-business",
